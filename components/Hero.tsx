      ...
      <div className="relative flex h-screen w-full items-center justify-center bg-white dark:bg-black-100">
        <div
          className={cn(
            ...
            "[background-image:linear-gradient(to_right,#e4e4e7_0.03px,transparent_0.5px),linear-gradient(to_bottom,#e4e4e7_0.03px,transparent_0.5px)]",
            "dark:[background-image:linear-gradient(to_right,#262626_0.03px,transparent_0.5px),linear-gradient(to_bottom,#262626_0.03px,transparent_0.5px)]"
          )}
        />
